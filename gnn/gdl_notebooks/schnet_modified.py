...
class SchNetModified(torch.nn.Module):
    ...
    def __init__(
        ...
        self.embedding = Linear(input_dim, hidden_channels)
        ...
        # self.node_and_edge_feats = Linear(hidden_channels + edge_dim, hidden_channels)
    ...
    def forward(self, data) -> Tensor:
        ...
        # h = self.node_and_edge_feats(torch.cat([h, edge_feat], dim=1))
        h = self.lin1(h)
        h = self.act(h)
        h = self.lin2(h)
